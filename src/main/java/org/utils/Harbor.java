...
public class Harbor extends WebSocketClient {
    ...
    private Harbor() throws URISyntaxException {
        super(new URI(_url));
    }

    private static synchronized Harbor getInstance(){
        if(instance==null){
            try {
                instance = new Harbor();
            }catch (Exception e){
    ...
    public static void main(String[] args) {
        Harbor.getInstance().setupHarbor(new Delegate() {
            @Override
            public void onLoginSuccess() {
                ...
                object.put("cmd","103");
                object.put("id", _id);
                Harbor.getInstance().sendMessage(object.toJSONString());
            }
